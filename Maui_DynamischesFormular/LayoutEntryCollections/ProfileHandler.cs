        ...
        public static class ProfileHandler
        {
            ...
            {      
                var profileCatalogDictionary = new Dictionary<string, TransportItem>()
                {
                    ...
                    {nameof(profSet.DataGroupID),        new TransportItem() { TabNo = 0, Name = nameof(profSet.DataGroupID),         DisplayName = nameof(profSet.DataGroupID),    TypeIdentifier = WorkItem.TypeID.RsStringNo,    Content = new StringTypeContent()   { Value = profSet.DataGroupID } } },
